    ...
    <footer className="bg-cc-primary text-white pt-20 pb-10 border-t border-white/10">
      <div className="max-w-[1600px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
           ...
           <div className="md:col-span-2">
              ...
              <p className="text-gray-400 max-w-md leading-relaxed mb-8 font-light text-sm">
                 We are a wholesale-only supplier. We do not sell to the general public. 
                 Specializing in bulk commodity trading and logistics for the global market.
              </p>
           ...
           <div>
              <h4 className="font-bold text-sm uppercase tracking-widest mb-6 text-gray-500">Headquarters</h4>
           ...
           <div>
              <h4 className="font-bold text-sm uppercase tracking-widest mb-6 text-gray-500">Business</h4>
              <ul className="space-y-3 text-gray-400 text-sm">
                 <li><a href="#" className="hover:text-white transition-colors">Corporate Profile</a></li>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-600 font-mono">
           <p>© {new Date().getFullYear()} CC Food Stuff Group. All Rights Reserved.</p>
